    ...
    "birthday-decoration": [
      {
        ...
        </p><p>We, at Hora Services, have been in the business of  <a href='https://horaservices.com/balloon-decoration/birthday-decoration' style="color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;"> birthday decorations </a> for years now, and each celebration still brings a smile to our faces. To be able to make such a special occasion even more special with our unique birthday decorations is a blessing and we do not take it for granted. Over the years, we have perfected this art so that you can have Instaworthy events in the comfort of your homes.</p>
      ...
      },
      {
        ...
        <p>what's a birthday without a present! Find the perfect gift here to match the occasion! understand</p>`
      },
      {
      ...
      },
      {
        ...
        "htmlContent": `<p>Hora Services is available online at all times and at our headquarters during office hours in Delhi. Our services extend all over India in every major state and city like
        ...
        <p>Want birthday decorations at your home in Delhi NCR? Look no further than at Hora Services!</p>`
      },
      {
        "title": "Why Choose Us?",
        "htmlContent": `<ul>
...
,      
  ...
  <p>Sit back and relax – our team has everything under control, and you're all set!</p>`
    ...
    [
        {
            "title": "Get the Most Romantic Anniversary Decorations only at Hora Services!",
            "htmlContent": `<p>Woo your partner with trendy celebrations!</p>
            <p>We, at Hora Services, vouch for celebrations and how necessary they are to enjoy life. To get together with your loved ones in a beautiful place, dressed all glamourous, to celebrate life events is something of a great blessing, honestly. Anniversaries especially, are these amazing milestones in life that are symbolic for people of how far they have come, together, to be celebrated on a day meant only for them. So how about we give this day its due importance?</p>
            <p>It could be your <a href='https://horaservices.com/balloon-decoration/anniversary-decoration/product/Roseate-Radiance-Anniversary-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'> 1st month anniversary, </a> <a href='https://horaservices.com/balloon-decoration/anniversary-decoration/product/White-&-Gold-Enchantment-Anniversary-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'> 1st year anniversary, </a> or even your 25 year anniversary, Hora Services has experiences for every occasion so you can make your loved ones feel special and show them what they mean to you. Throw a party, a getaway to a nice hotel or Airbnb, or even a surprise trip to somewhere nice, Hora Services will be there to spice up the atmosphere with the most beautiful and romantic decorations. Let us turn your special day into one of the most joyous days of your life!</p>
            <p>With our variety of Anniversary decorations that include but are not limited to fairy-like canopies, rose trails, balloon ceilings, and sequin backgrounds, you are bound to find something to suit your every taste and need! Be it your marriage anniversary, your parent's marriage anniversary, your relationship anniversary, or even a friendship anniversary, Hora Services has experience in providing every kind of anniversary decoration to its customers!</p>
            <p>So, book now to reserve your special dates and mark a beautiful milestone with your loved ones. We'll take care of the rest, so you can enjoy your anniversary with your special someone!</p>`
          },
          {
          ...
          {
            "title": "Milestone Anniversary Decorations",
            "htmlContent": `<p>For organisations, there are milestones like silver jubilee, golden jubilee, and so on. On the other hand, there are so many milestones for relationships that it is hard to count! People celebrate their 1st month, 6th month, 1st year, when they brought a place together, their first date, their marriage, and the list goes on and on and on.</p>
            <p>Hora Services has dedicated anniversary decorations for every such occasion so you can celebrate all the precious moments of your life with your loved ones. Open to various customisations, our decorators will make sure these decorations suit your needs and aesthetic perfectly!</p>`
          },
          {
            "title": "Anniversary Decorations for Parents",
            "htmlContent": `<p>From growing up witnessing the love between your parents to seeing them completing major milestones in their journey together, love takes shape into a beautiful emotion for children. Just like the era they grew in love, surrounding their anniversary decorations with retro songs and pictures from their youth can bring back so many memories. If the newly married couple can have their pre-wedding photoshoot run through the wedding, why can't your parents?</p>
            <p>That’s why, these decorations by Hora Services are specially designed to be the perfect balance of romance, family, and nostalgia. Plan a perfect surprise for your parents so they can remember how they fell in love, all over again!</p>`
          },
          {
            "title": "Balloons Anniversary Decorations",
            "htmlContent": `<p><a href='https://horaservices.com/balloon-decoration/anniversary-decoration/product/Anniversary-Special-Balloon-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'> Balloons Anniversary </a> are available in so many colours and shapes, and the best part? You can use each of them together to create harmony and a colourful atmosphere. On your anniversary, how would you feel promising your beloved a lifetime of love and happiness under a balloon arch? We also believe in ageless celebrations. So, if you want to burst a balloon filled with candies and chocolates to relive the youthful days when you and your partner met, we'll be happy to cheer you on and set up the whole thing.</p>
            <p>Also, as they say, is it even a celebration without balloons all around you?</p>`
          },
          {
            "title": "Canopy Anniversary Decorations",
            "htmlContent": `<p>Let's just be honest: sometimes, you might not want to get your family involved in your celebrations. You simply want to keep it a romantic and private celebration, just for the two lovebirds. <a href='https://horaservices.com/balloon-decoration/anniversary-decoration/product/Bed-Decor-With-Love-Moment-' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'> Canopy anniversary </a> decorations are perfect for such occasions in every way possible. They are beautiful and oozy, take minimal space, and spell a lovely romantic evening like nothing else.</p>
            <p>Just imagine soulful music playing through a makeshift fort in the privacy of your own house with fresh and fragrant flowers and delicious food of your choice. It is the perfect way to spend some quality time with your partner and go down memory lane while sitting in the safety and comfort of your own abode. Sounds wonderful, right? And that’s before even knowing that you can keep most of the decoration intact at your place for later!</p>`
          },
          {
            "title": "Where Can You Find Us?",
          ...
          },
          {
            "title": "Why Choose Us?",
            "htmlContent": `<p><ul>
<li style="font-weight:400" aria-level="1">Hora Services takes customisability to the next level. Add a cake, send e-invites, make the balloons shiny, maybe a tweak in the design, anything your mind can think of, we will do it!</li>
<li style="font-weight:400" aria-level="1">With an experience of more than 7 years making celebrations stand out, we adhere to strict rules and guidelines to make sure the festivities don’t stop. You can expect on-time delivery, always!</li>
<li style="font-weight:400" aria-level="1">Hora Services delivers PAN India which means that where you are, we will reach you in no time!</li>
<li style="font-weight:400" aria-level="1">With a variety of more than 50 experiences to choose from, you are sure to find a decoration that speaks to you. And if you want to explore more, our team is more than ready to help you!</li>
</ul></p>
...
<p>Prepare for the most magical experience of your life with your loved ones and celebrate your anniversary as the joyous occasion it is.</p>
<p>Congratulations from Hora Services!</p>`
          }          
      ],
      "first-night-decoration": [
            {
              "title": "The Art of First Night Decoration",
              "htmlContent": "<p>The first wedding night is always special for a couple. To make it extra special, people like to decorate the rooms. First-night decorations make the room more attractive and charming.</p>"
            },
            {
              "title": "Why Choose First Wedding Night Decorations?",
              "htmlContent": "<p>First Wedding Night Decorations enhance your moments. Decorations with balloons and flowers in your room can make your partner happy and add romance to your night.</p>"
            },
            {
              "title": "How to Arrange First Night Room Decoration?",
              "htmlContent": "<p>Arranging a first-night room decoration is simple. Just choose the best options from Hora Services that your partner will love, like the <a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Wedding-Night-Room-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'> Premium First Night Theme Decor</a> or <a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Romantic-Wedding-Room-Decor' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'> Happy Wedding First Night Decor </a>.</p>"
            },
            {
              "title": "First Night Decoration Ideas",
              "htmlContent": "<p>You can find numerous first-night decoration ideas on Hora Services's website. Options like canopy decoration, balloon decoration, or flower petals decoration create a romantic atmosphere.</p>"
            },
            {
              "title": "Do We Provide Wedding Night Room Decoration?",
              "htmlContent": "<p>Yes, Hora Services offers various decorations for occasions from birthday celebrations to wedding nights. Choose your preferred decor from options like Happy Wedding First Night Decor and First Night Red Balloon Canopy Decor.</p>"
            },
            {
              "title": "Best Room Decorations for First Wedding Night",
              "htmlContent": `<p>Hora Services offers several popular decorations for your first wedding night, including:</p>
              <ul>
              <li><a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Romantic-Red-&-Gold-Decor' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'>First Night Red Balloon Canopy Decor</a></li>
              <li><a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Wedding-Night-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'>Premium First Night Theme Decor</a></li>
              <li><a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Golden-Balloon-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'>Happy Wedding First Night Decor</a></li>
              <li><a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Bed-Decoration-For-First-Night' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'>Romantic canopy decorations</a></li>
              <li><a href='https://horaservices.com/balloon-decoration/first-night-decoration/product/Camping-Bed-Decoration' style='color: rgb(150, 82, 141);font-weight: bold; text-decoration: underline;'>Golden Just Married Car Boot Decor</a></li>
              </ul>`
            },
            {
              "title": "Why Choose Hora Services Services?",
              "htmlContent": "<p>Hora Services understands your emotions and the importance of your event. We aim to provide the best decorations and candlelight dinners to make your occasion memorable.</p>"
            },
            {
              "title": "How to Book First Night Decoration?",
              "htmlContent": "<p>Booking Hora Services services is easy. Just follow these steps:<ol><li>Select your preferred experience or decoration.</li><li>Choose your date and time.</li><li>Fill in your address and other details.</li><li>Complete the payment.</li></ol>Enjoy your booking!</p>"
            }
    ...
    [
        {
          ...
          {
            "title": "Baby Shower Ideas For A Charming Celebration At Home/Banquet Hall",
          ...
          {
            "title": "Add A Pop of Excitement To Your Celebration With Floral Baby Shower Ideas",
          ...
          {
            "title": "Discover Traditional Godh Bharai Decoration Ideas For Sacred Celebrations",
          ...
          {
            "title": "Heartwarming & Simple Baby Shower Decorations For Anganwadi Gatherings",
          ...
          {
            "title": "What happens at a Godh Bharai Ceremony?",
          ...
          {
            "title": "Who Hosts the Baby Shower?",
            "htmlContent": "<p>For godh bharai ki rasam, It is usually the responsibility of the closest friend of the mother or her family like sisters, mother, mother-in-law, or sometimes herself. However, anyone can host the baby shower!</p>"
          },
          {
            "title": "Could You Provide Some Godh Bharai Ideas For An Outdoor Stage Decoration?",
            "htmlContent": "<p>For delightful Godh Bharai ideas, infuse charm with pastel-colored balloons and vibrant floral arrangements. Opt for e-invites for a modern touch, and incorporate traditional games for entertainment. Create a cozy ambiance with plush seating and use baby-themed props for a playful photo booth. Craft a diverse menu blending traditional and contemporary flavors, topped with a baby-themed cake. Ensure personalized touches through custom signage, banners, and a carefully curated playlist. Capture the special moments with a professional photographer, and set up a designated area for gifts. This thoughtful combination of decorations, activities, and elements will help you plan a perfect godh bharai function to make the celebration memorable for the mom-to-be and guests alike.</p>"
          },
          {
            "title": "How to do the Baby Shower Decorations?",
            "htmlContent": "<p>The godh bharai decoration at home can be organised according to the theme or to the taste of the mother to be. It can include things like confetti, balloons, a decorated food table, cake, etc. One can always do the decorations by themselves but the Hora Services services for a baby shower decoration is also a great idea. For more baby shower decoration ideas check the decorations above.</p>"
          },
          {
            "title": "What Could be Some Ideas for a Baby Shower Invitation?",
          ...
          {
            "title": "What Could be Some Baby Shower Cake Ideas?",
            "htmlContent": "<p>The cake is one of the highlights of a baby shower. So, it has to be something special. You can always do things like customising the cake to look like a baby’s bib or a toy. You can also be creative with a funny baby-related message on a simple cake.</p>"
          },
          {
            "title": "What Could be Some Perfect Seemantham Ceremony Gifts?",
          ...
          {
            "title": "What Baby Shower Games Can Be Played to Make it a Fun Party?",
          ...
          {
            "title": "How Can I Plan A Simple Godh Bharai Decoration at Home?",
          ...
          {
            "title": "When Should One Have a Baby Shower?",
            "htmlContent": "<p>It is usually preferred to have the baby shower a couple of weeks before the due date so that the mother has enough time to gather supplies and she is comfortable enough to enjoy the party.</p>"
          },
          {
            "title": "How to Host a Budget-Friendly Baby Shower?",
...
,        
          ...
          {
            "title": "Wrapping Up!",
            "htmlContent": "<p>So, let’s celebrate the joy of motherhood with a gorgeous and memorable baby shower ceremony and Hora Services these beautiful moments forever. Book your decorations with Hora Services now!</p>"
          }   
    ],
    "welcome-baby-decoration":
    [
        {
            "title": "Trending and Aesthetic Baby Welcome Decorations from Hora Services!",
            "htmlContent": `<p>Welcome your baby in style!</p><p>A milestone as big as welcoming a new life into the world needs to be celebrated, there’s no doubt about that. But we cannot leave it all to the new parents amidst all the worry and chaos they might be going through! This is why Hora Services has a great range of safe Baby Welcome Decorations to celebrate the glorious occasion as you welcome your bundle of joy into the world.</p><p>Imagine your child’s happiness when they are older and will look at the pictures and witness the happiness on everyone’s face. Be it a hospital room, an outdoor garden, or even a room in your house, we will whip up an Instagram-worthy party according to your aesthetics.</p><p>With various themes and ideas for every occasion, our expert team of decorators takes care of everything so you can be with your friends and family and enjoy your heart. Capture the memories of people peeking at the sleeping baby as the new mother beams with pride.</p><p>It is the start of a new life, for both the child and the parents, and Hora Services wishes them all the best in this new chapter. Don’t worry, when it comes to celebrations and festivities, we have your back!</p>`
          },
          {
            "title": "Baby Welcome Decoration Themes in Delhi NCR",
            "htmlContent": `<p>After due research, experience, and catering to a wide audience in India, our decorators have numerous ideas and designs for Baby Welcome decorations limited only to the imagination. Check out our catalogue on our website to find an experience that suits your budget and aesthetic.</p><p>And if you need some ideas, we have got them below for you.</p>`
          },
          {
            "title": "Baby Girl Welcome Decoration",
            "htmlContent": `<p>Specially curated for the girl child, these Baby Girl Welcome Decorations are one of the most aesthetically pleasing experiences on our website. Just like how a girl is the twinkle of their parent’s eyes, these shimmering and gleaming decorations of pink, white, or purple are bound to tell everyone that a princess has arrived into the world! Let the unicorns and fairies in these newborn baby girl welcome decorations herald this welcome loud and clear!</p>`
          },
          {
            "title": "Baby Boy Welcome Decoration",
            "htmlContent": `<p>Hora Services has got the perfect Baby Boy Welcome Decorations for your energetic chub! In shades of blue and white with jazzy lighting, these decorations spell ‘It’s a boy!’ without even needing to. With dreams of being a superhero or a prince, your newborn baby boy will feel at complete ease in these baby-safe material balloons, flowers, and lights. So feel free to indulge in these decorations specially curated for baby boy welcome!</p>`
          },
          {
            "title": "Baby Welcome Balloon Decorations",
            "htmlContent": `<p>There is no celebration without an enormous number of balloons carefully scattered, taped, and made into beautiful arches. Our decorators are extremely proficient in creating some of the best Baby Welcome Balloon decorations to ever exist on the planet. So spice up your home or the hospital with balloons of varying colours and sizes, carefully crafted into an aesthetic welcome stage for your precious baby.</p>`
          },
          {
            "title": "Baby Welcome Pastel Decorations",
            "htmlContent": `<p>Pastel has never been out of fashion and never will be. Colours that are just so pleasing eyes and suit children so well are perfect for the purpose of Baby Welcome Decorations. We have beautifully integrated the perfect shades of pastel into balloons, flowers, sequins, and even LED lights to create aesthetic blends and decorations to be customised as the heart desires. So really, what are you waiting for? Go Pastel, go baby!</p>`
          },
          {
            "title": "Where Can You Find Us?",
            "htmlContent": `<p>Find the best Baby Welcome decorations anywhere in Delhi NCR. Hora Services has spread its reach all over the nation, be it Jammu, Indore, or Delhi NCR. We always strive to make sure that we can reach our customers wherever they are since the festivities should not stop!</p><p>We are available online over all social media platforms like Facebook, Instagram, Twitter, and even WhatsApp! Reach out to us and tag us in your celebrations. Our team of expert decorators love to see the happiness they bring with their efforts.</p><p>Visit our website for any occasion like a Baby Welcome, Birthdays, Baby Shower, etc and simply choose Delhi NCR in the location section to see the available experience in your region. We hope to be a part of your festivities as well as we can.</p><p>Hora Services wishes all new parents a beautiful life with their baby!</p>`
          },
          {
            "title": "Why Choose Us?",
            "htmlContent": `<ul><li>We are known for our PAN India availability as we put all the efforts to reach where you are!</li><li>With an experience of more than 7 years, we have honed our craft and logistics to make sure we give the best experiences to our customers!</li><li>Our catalogue of experiences has various categories filled with enough decorations to last lifetimes!</li><li>Our experiences are open to various customisations which our decorators are more than happy to fulfill.</li><li>Expect prompt and on-time delivery of services from Hora Services. Don’t believe us? Check the reviews on our website!</li></ul>`
          },
          {
            "title": "Celebrate your Bundle of Joy with Hora Services!",
            "htmlContent": `<p>Book Baby Welcome Decorations now and celebrate this milestone with a perfect party!</p><p>The process is streamlined to be as easy as it could be.</p><ol><li>Go through the multitudes of themes and decorations and pick your favourite one.</li><li>Confirm the timings and location to check availability.</li><li>Customise as your heart desires.</li><li>And confirm the booking.</li></ol><p>That’s it. Our team of decorators will show up on time and transform the house, room, or even hospitable into a magical place! That’s a Hora Services promise!</p>`
          } 
    ],
    ...
    [
        {
          "title": "Enjoy the Premium Decorations for your Birthdays, Anniversaries and more.",
          "htmlContent": `<p>Whether it’s your <em>18th birthday or 40th, 25th anniversary or 50th</em>, our premium decor will bring luxury and elegance to your celebration. The high-end decorations are curated with high-quality items and bring a whole different aura all around the venue.</p><p>Your birthday party, anniversary surprise and baby shower celebration will have a much more classy look with premium decors. If you want to add glamour to your events, these decors will work perfectly!</p><p>Many people have questions regarding the Premium Decoration section on our website, so we thought that it’ll be much better to answer some common questions for clarification-</p>`
        },
        {
          "title": "Why Should I Go for Premium Balloon Decorations?",
          "htmlContent": `<p><em>Premium Balloon Decorations</em> bring a classy and luxurious look to your venue thereby making your celebration much more attractive. This is why going for <em>Premium balloon decoration</em> can be one of the best things to do. Moreover, premium balloon decorations are available for Birthdays, anniversaries, baby showers, and more. So, you can easily find stylish and high-quality decorations for your event.</p>`
        },
        {
          "title": "What are some Different Premium Birthday Decorations Available in Delhi NCR?",
          "htmlContent": `<p>There are many premium birthday decorations available at Hora Services. So, you can make your celebrations exquisite by having any one of these-</p><ul><li>Sparkling Birthday Neon Lights Decor</li><li>Glorious Birthday Neon Lights Decor</li><li>Casino Theme Birthday Decor</li><li>Premium Sequins And Neon Light Decor</li></ul><p>These decorations are in-trend and will make your party exquisite.</p>`
        },
        {
          "title": "Are there any Neon Lights Decorations Available?",
          "htmlContent": `<p>Yes, in the Premium Decors Category, we have Neon Lights Decorations that are in trend and give a classy look to your event. With these decorations, not only you, but all your guests are likely to get impressed too.</p><p>Here are some of the best Neon Lights Decorations Available. You can get them customized as per your occasion by discussing with the team-</p><ul><li>Sparkling Birthday Neon Lights Decor</li><li>Glorious Birthday Neon Lights Decor</li><li>Happy Birthday Neon Light Decoration</li><li>Premium Sequins And Neon Light Decor</li><li>Glamorous Pink Sequins Decor</li></ul>`
        },
        {
          "title": "Can you suggest a Premium Room Decoration for a Birthday Surprise?",
          "htmlContent": `<p>We have curated several decorations that will make your celebrations memorable. For Birthdays, you can choose to go for Happy Birthday Neon Light Decoration, Premium Sequins And Neon Light Decor, and more like these. You can check out all the options above to find the perfect one according to your preference.</p>`
        },
        {
          "title": "Are there any Premium Balloon Decoration for Baby Shower Celebrations in Delhi NCR?",
          "htmlContent": `<p>Yes, we have also curated premium balloon decorations for baby showers that you can surprise your close ones with. You can throw a gorgeous baby shower for your sister, wife, and more. There are several that you can choose from-</p><ul><li>Gold Baby Shower Decor</li><li>Oh! Baby Premium Baby Shower Decor</li><li>Rose Gold Ring Baby Shower Decor</li><li>Gold and Blue Ring Baby Shower Decor</li></ul>`
        },
        {
          "title": "What all areas do you service in Delhi NCR for Premium Decorations at Home?",
          "htmlContent": `<p>We cover ALL localities in delhi - Adarsh Nagar, Ashok Vihar, Begum Pur, Karala, Model Town, Narela, Pitam Pura, Rohini Sub City, Shalimar Bagh, Civil Lines, Gulabi Bagh, Kamla Nagar, Kashmiri Gate, Kotwali, Mori Gate, Sadar Bazaar, Sarai Rohilla, Shakti Nagar, Shastri Nagar, Tis Hazari, Timarpur, Wazirabad, Dilshad Garden, Naveen Shahdara, New Usmanpur, Shahdara, Shastri Park, Yamuna Vihar, Chandni Chowk, Daryaganj, Jhandewalan, Karol Bagh, Kishanganj, Paharganj, Rajender Nagar, Barakhamba Road, Chanakyapuri, Connaught Place, Gole Market, INA Colony, Laxmibai Nagar, Pragati Maidan, Vinod Nagar, Jhilmil Colony, Laxmi Nagar, Mayur Vihar, Pandav Nagar, Preet Vihar, Anand Vihar, Vasundhara Enclave, Vishwas Nagar, Vivek Vihar, Alaknanda, Chittaranjan Park, Defence Colony, East of Kailash, Govindpuri, Greater Kailash, Green Park, Gulmohar Park, Hauz Khas, Hauz Khas Village, Jangpura, Jor Bagh, Kalkaji, Khanpur, Lajpat Nagar, Lodi Colony, Malviya Nagar, Mehrauli, Neeti Bagh, Nehru Place, Netaji Nagar, New Friends Colony, Nizamuddin West, Okhla, Safdarjung Enclave, Sainik Farm, Saket, Sangam Vihar, Sarita Vihar, Sarojini Nagar, Sarvodaya Enclave, Siri Fort, South Extension, Sriniwaspuri, Sundar Nagar, Tughlaqabad, Badarpur, Dabri, New Delhi, Dwarka Sub City, Delhi Cantonment, Dhaula Kuan, Inderpuri, Mahipalpur, Moti Bagh, Munirka, Najafgarh, Naraina, Palam, Rama Krishna Puram, Sagar Pur, Vasant Kunj, Vasant Vihar, Ashok Nagar, Bali Nagar, Fateh Nagar, Kirti Nagar, Moti Nagar, Paschim Vihar, Patel Nagar, Punjabi Bagh, Rajouri Garden, Tihar Village, Tilak Nagar, Vikas Nagar, Vikaspuri.</p>`
        },
        {
        ...
        },
        {
          ...
          "htmlContent": `<p>Follow the steps below to book an online with us:</p><ul><li>Choose a <strong>Premium Decoration online</strong> for birthdays or any other event according to your choice.</li><li>Select the date and time for the delivery.</li><li>Fill in the required details like your address, requirements, customizations, etc.</li><li>Complete the payment process.</li></ul><p>That’s it, you’re done! All you have to do is sit back and relax while our team does the job for you!</p>`
        }
      ],
      ...
      [
        {
          "title": "Why Haldi ceremony is done?",
          "htmlContent": `<p>The Haldi ceremony is a ritual that is done in many Indian weddings. Known by different names in different regions, like the ubtan in North India, halad chadavne in Maharashtra, tel ban in Jain weddings, and pellikuthuru in Telugu, pithi in Gujarat, and many others, it is a must-have ceremony in any Hindu Indian wedding. It is organized to mark the happy beginnings of the new couple. The ritual is followed as a cleansing and purifying act for the couple's body and also to safeguard them from any negativity before the wedding. It is believed to cleanse the couple and their guests of any bad luck or bad spirits that may be present during the wedding.</p>
          <p>The ceremony is performed by an astrologer and includes prayers, worship of deities, and offerings. During the Haldi ceremony, family and friends smear a special paste of haldi on their faces and bodies. It is usually performed right before the wedding ceremonies and it is usually accompanied by the best haldi decoration, traditional music and dancing.</p>`
        },
        {
          "title":"How can we decorate Haldi at home in Delhi NCR?",
          "htmlContent": `<p>Haldi celebrations during wedding ceremonies are an essential part of Indian culture. Even when celebrating at home, you would like to have a feast of celebration that is memorable for the bride or the groom to be or your guest. Haldi decoration at home must be grand and warm. For this, you must use bright colours and patterns. This is the time to be festive! Adding flowers and impressive backgrounds can be charming too. While you are thinking of some extraordinary ideas, we at CherishX have crafted some out-of-the-box haldi function decoration that will leave everyone in awe!</p>
          <p>To start with, you can choose a haldi decoration at home simple idea of a Mandala and Flower setup that creates a perfect vibrant ambience. You can also choose Pink and Yellow Flamingo theme decor suitable even for a haldi decoration at terrace.</p>`
        },
        {
          "title": "What are the best haldi decoration ideas in Delhi NCR?",
          "htmlContent": `<p>As the days leading up to Indian weddings approach, there are many things to think about, but one of the most significant is the decoration for the Haldi ceremony. While the tasks at hand are already daunting, thinking of stunning decor ideas can be overwhelming too. In such scenarios, CherishX brings to you smart and sparkling haldi decoration ideas that will add a unique and colourful touch to your Haldi ceremony. You can choose between traditional or modern haldi decoration ideas with the best bride-groom haldi decoration ideas.</p>
          <p>When celebrating at a banquet or destination wedding, you can choose Peacock Haldi decor, an ideal haldi ceremony decoration. This excellent theme is a cluster of haldi background decoration and accessories that will add a glamorous touch to your wedding. If you are celebrating at home, you can choose our special Lotus Urli haldi Decor which is exclusively designed for haldi decoration at home with flowers, brass pots, and classic lamps that create the traditional feel.</p>`
        },
        {
          "title": "What are some of the haldi background decorations for the groom",
          "htmlContent": `<p>It is the most important time of their life, and the groom is the centre of attention during this special day, and it is essential to make him feel comfortable and special. One of the creative ways to make the groom feel special is by adding exclusive haldi decoration background for the ceremony. He is sure to be delighted with elegant decor and colours that he can’t find anywhere else. Whether it's a traditional theme or something more modern like the Persian theme decor, an intricate and beautiful decorative setup will set the tone for a perfect ceremony.</p>
          <p>If you want to set the best experience at home, you can choose our extraordinary haldi decoration at home for groom. We have the Peacock or the Quirky Flamingo theme décor designed to suit your surroundings and wedding style.</p>`
        }
      ],
      ...
      [
        {
          "title": "Why Should I have a Bachelorette Party Theme Decorations?",
          "htmlContent": `<p>If you are throwing a bachelorette party for your friend, or sister, you must focus on bachelorette party theme decorations. It adds to your party. Decorations create a whole different environment. This will help you to have a more happening party. Bachelorette party decorations are specially curated to celebrate the occasion of the 'bride to be’. So, you should have the decorations to enhance your party.</p>`
        },
        {
          "title": "How Should I Organise Bachelorette Party Decorations?",
          "htmlContent": `<p>Organising Bachelorette Party Decorations becomes easier with CherishX. You can simply choose your favourite decor and book with us. Our team makes sure to give you a decoration that you’ll love. You can choose among various decorations to make your bachelorette party lively and going.</p>`
        },
        {
          "title": "Do You Offer Any Bachelorette Theme Party Decorations?",
          "htmlContent": `<p>Yes, CherishX offers you several bachelorette theme party decorations that will add fun to your party. You can choose to go for Glamorous Bridal Shower ,The bride's bachelorette decor, Bachelorette Theme Backdrop, or Bachelorette Surprise. These decorations are specially curated keeping in mind the occasion. CherishX offers you these decorations to make your party more charming.</p>`
        },
        {
          "title": "Why Should I Choose CherishX Services for a Bachelorette Theme Decoration?",
          "htmlContent": `<p>We understand your emotions! We know how important the event is for you and this is why we put our all to give you the best decorations and . We arrange the event that is worth remembering for you! You can choose Bachelorette Theme Decorations to surprise the ‘bride to be’. We do our best to keep you and your loved one happy!</p>`
        }
      ],
      
    "balloon-bouquets-decoration":
     [
        {
            title: "Celebrate Your Special Occasions with Balloon Bouquets",
            htmlContent: `<p>Life is filled with significant occasions, and marking them with unique balloon bouquets brings an abundance of warmth, joy, and excitement into someone's life. Whether you are celebrating an anniversary, a birthday, or any other occasion, these moments need to be Hora Servicesed. Adding something special to your occasions such as balloon boxes, bouquet of chocolates, or balloon bouquets with flowers can make your celebrations much better.</p>`
          },
          {
          ...
          },
          {
            ...
            htmlContent: `<p>Balloon boxes or bouquets are filled with balloons and sometimes combined with flowers. People rarely expect these surprises, which makes them a stunning gift option!</p>`
          },
          {
            title: "Will the Balloons Fly Out When the Balloon Surprise Box Opens?",
            htmlContent: `<p>Yes! The balloons fly out when the balloon box is opened, making a lovely surprise for the recipient.</p>`
          },
          {
            title: "How Long Do Balloons Last in a Surprise Balloon Gift Box?",
            htmlContent: `<p>A 9-12” latex helium-filled balloon will last 3 to 4 hours in a box, perhaps longer if it’s of good quality. Chilled areas help prolong their life.</p>`
          },
          {
            title: "Can I Get Same Day Bouquet Delivery?",
            htmlContent: `<p>Yes, we offer same-day balloon bouquet delivery and flower bouquet delivery for your convenience.</p>`
          },
          {
            title: "For What Occasions can Balloon in a Box Surprise be Used?",
            htmlContent: `<p>The balloon box surprise can be used for birthdays, anniversaries, proposals, and more. Check out our popular balloon box gifts for various occasions.</p>`
          },
          {
            ...
            htmlContent: `<ul style="margin-left: 15px;">
                          ...
                          <p>It depends on the kind of balloon box you pick. For more details, visit Hora Services.</p>`
          },

          {
            ...
            htmlContent: `<p>We provide 100+ options for balloon bouquets for birthdays and bouquets for anniversaries. Our offerings also include:</p>
                          <ul style="margin-left: 15px;">
                            ...
                            <li>Mother's Day bouquets</li>
                            <li>Gifts for husband on Valentine's Day</li>
                            <li>Christmas gifts</li>
                            <li>Bouquets for engagements</li>
                            <li>New Year gifts</li>
                          </ul>
                          <p>Whether it's any occasion, we have the best selection of bouquets of chocolates, flower bouquets, and more. Our best-selling chocolate bouquet is the Ferrero Rocher bouquet.</p>`
          },
          {
          ...
          },
          {
            ...
            htmlContent: `
                          <p>Yes, we have Helium Balloon Boxes that you can book. They are best if you are trying to surprise someone. When people open a box, they don’t expect balloons coming out of it, which is why they create the best surprise gift.</p>`
          },
          {
            ...
            htmlContent: `<p>Birthday flowers and balloons go hand in hand. We have many flower options such as:</p>
                          <ul style="margin-left: 15px;">
                            ...
                            <li>Bouquet Lavender</li>
                            <li>Bouquet Yellow Roses</li>
                          </ul>`
          },
          {
            title: "Finding Love Balloon Boxes Online",
            htmlContent: `<p>Love balloon boxes are perfect for giving on occasions such as birthdays and anniversaries. You can express your love through love balloon boxes. Make your loved one happier by putting a smile on their face with these cute surprises. You can easily find these online. We have specially made “Love balloon boxes” so that people can plan an adorable surprise for their loved ones. Boxes such as Proposal with a Pop, Rose Gold 7 Promises Surprise Box, Surprise Box, Love Bubble, and Pictures Bucket can make your surprise more beautiful and memorable.</p>`
          },
...
,        
          {
            ...
            htmlContent: `<p>You can book a Balloon Gift Box on Hora Services by following the below steps:</p>
                          <ol>
                            <li>Choose a balloon box according to your taste.</li>
                          ...
                          <p>That’s it, you’re done! All you have to do is surprise your loved one with this amazing gift. So, explore our website and look out for balloon bouquet ideas, surprise box gift ideas, and more. You will adore them for sure!</p>`
          }
      ]      
      
  };

  export default categoryFooterData;