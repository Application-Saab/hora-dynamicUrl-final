        ...
        <button
          ...
          onClick={() => {
            ...
            item.selectedItems.forEach((selectedItem) => {
              const isDuplicate = selectedItems.some(existingItem => existingItem.title === selectedItem.title);
              if (!isDuplicate) {
                selectedItems.push({
            ...
            console.log(JSON.stringify(selectedItems), "json");

            localStorage.setItem('selectedItems', JSON.stringify(selectedItems));

            window.location.href = '/party-food-delivery-live-catering-buffet/party-food-delivery';
          }}
        >
          Book Now
        </button>
