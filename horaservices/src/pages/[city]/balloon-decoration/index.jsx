...
console.log(hasCityPageParam, "hasCityPageParam" );
const [catalogueData, setCatalogueData] = useState([]);
const [activeIndex, setActiveIndex] = useState(null);
const [showMore, setShowMore] = useState(false);
const [decCat, setDecCat] = useState([
        { id: '2', image: BirthdayImage, link:"" , name: 'Birthday', subCategory: "Birthday" , catValue:"birthday-decoration" , imgAlt:"A Gorgeous Candy Birthday Decoration Surprise!" },
        ...
        { id: '9', image: BallonBImage, link:"/balloon-decoration/balloon-bouquets-decoration" , name: 'Ballon Bouquets', subCategory: "BallonBouquets" , catValue:"balloon-bouquets-decoration" , imgAlt:"Balloon Bouquet" },
         ...
         const toggleFAQ = (index) => {
          ...
          const openCatItems = (item) => {
            // Dispatch your state with subCategory and imgAlt
            dispatch(setState(item.subCategory, item.imgAlt));
        
            // If hasCityPageParam is true, append the city to the URL
            if (hasCityPageParam) {
                router.push(`/${city}/balloon-decoration/${item.catValue}`);
                console.log("this one");
            } else {
                // Fallback URL without the city param (you can change it if necessary)
                router.push(`/${city}/balloon-decoration/${item.catValue}`);
