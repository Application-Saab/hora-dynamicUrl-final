...
const TermsCondition = () => {
  return (
    <div class="page-width">
        ...
        <p>
            These terms and conditions outline the rules and regulations for the use of Horaservices.com. 
        ...
        <p>
            ...
            "Our", and "Us" refer to our Company. "Party", "Parties", or "Us" refer to both the Client and 
            ...
            services, in accordance with and subject to, prevailing law of India. Any use of the above 
        ...
        <h2>Cookies</h2>
        <p>
            We employ the use of cookies. By accessing Hora Services, you agreed to use cookies in agreement 
            with Hora Service's Privacy Policy. Most interactive websites use cookies to let us retrieve the 
        ...
        <h2>License</h2>
        <p>
            Unless otherwise stated, Hora Services and/or its licensors own the intellectual property rights 
            for all material on Horaservices.com. All intellectual property rights are reserved. You may access 
            this from Horaservices.com for your own personal use subjected to restrictions set in these terms 
            and conditions.
        </p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from Horaservices.com</li>
            <li>Sell, rent or sub-license material from Horaservices.com</li>
            <li>Reproduce, duplicate or copy material from Horaservices.com</li>
            <li>Redistribute content from Horaservices.com</li>
        </ul>
    
        <h2>Comments</h2>
        <p>
            Parts of this website offer an opportunity for users to post and exchange opinions and information 
            in certain areas of the website. Hora Services does not filter, edit, publish, or review Comments 
            prior to their presence on the website. Comments do not reflect the views and opinions of Hora 
            Services, its agents, and/or affiliates. Comments reflect the views and opinions of the person who 
            posts their views and opinions. To the extent permitted by applicable laws, Hora Services shall not 
        ...
        <p>
            Hora Services reserves the right to monitor all Comments and to remove any Comments which can be 
        ...
        <p>
            You hereby grant Hora Services a non-exclusive license to use, reproduce, edit, and authorize others 
        ...
        <p>
            ...
            the absence of Hora Services; and (d) the link is in the context of general resource information.
        </p>
        <p>
        ...
        <p>
            ...
            website, you must inform us by sending an e-mail to Hora Services. Please include your name, your 
        ...
        <p>
            No use of Hora Services's logo or other artwork will be allowed for linking absent a trademark license 
            agreement.
        </p>
        ...
        <p>
            ...
            defend us against all claims that are arising on your Website. No link(s) should appear on any Website 
        ...
        <p>
            ...
            at any moment. We will consider requests to remove links but we are not obligated to do so or to respond to 
            you directly.
        </p>
        <p>
