...
const Decoration = () => {
  ...
  const openCatItems = (item) => {
    ...
    console.log(item.subCategory, "subcategory");
    if (hasCityPageParam) {
  ...
  const KidsBirthdayData = [
    ...
    {
      Image:
        "https://i.postimg.cc/Ssk8C7pH/Pastel-Colored-Plain-Sticker-and-Typography-Motivational-Quote-Instagram-Post.png",
      title: "View More 800 + Design",
            ...
            return (
              <a key={index} className="slider-item" href={item.link}>
                ...
                {/* <div className="decorationdiscount">
                 ...
                 {/* Conditionally render price and rating */}
                 {item.price && ( 
                  <div className="decorationdiscount">
                    ₹{getDiscountedDifference(item.price)} off
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {item.price && ( // New line: Conditionally render price and original price if `price` exists
                    <div className="pri_details">
                      <div className="pro_price">
                        {/* <p>{item.price}</p> */}
                        <p>₹{getDiscountedPrice(item.price)}</p>
                      </div>
                    </div>
                  )}
                      </p>
  ...
  return (
    <div className="decoration-city-page-sec">
      ...
      {/* <div
          style={{ cursor: "pointer", display: "inline-block" }} // Makes the Lottie animation clickable
          onClick={() => handleViewMore(viewLink)}
        >
          <Lottie
