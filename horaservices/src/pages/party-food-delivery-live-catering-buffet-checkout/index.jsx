...
const FoodDeliveryCheckout = () => {
  ...
  const RenderDishQuantity = ({ item }) => {
    var dishObject = selectedDishQuantities.filter(
      (x) => x.name !== "Tawa Rotis" && x.name !== "Rumali Rotis"
    );
    ...
    const mainCourseItemCount = dishObject.filter(
      (meal) => meal.id[0] === "63f1b6b7ed240f7a09f7e2de"
    ).length;
    const appetizerItemCount = dishObject.filter(
      (meal) => meal.id[0] === "63f1b39a4082ee76673a0a9f"
    ).length;
    const breadItemCount = dishObject.filter(
            ...
            >
              ...
              >
                ...
                <p
                  ...
                  className="m-1"
                >
                  If the order is not assigned to the kitchen: You are eligible
                  for a 100% refund of the advance payment.
                </p>
                <p
                  style={{ fontSize: "13px", color: "rgb(157, 74, 147)" }}
                  className="m-1"
                >
                  If the order is cancelled more than 24 hours before the
                  scheduled delivery: You will receive a 50% refund of the
                  advance payment.
                </p>
                <p
                  style={{ fontSize: "13px", color: "rgb(157, 74, 147)" }}
                  className="m-1"
                >
                  If the order is cancelled within 24 hours of the scheduled
                  delivery: The full advance amount will be non-refundable, and
                  100% of the payment is required.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                >
                  ...
                  <p
                    ...
                    className="m-1"
                  >
                    If the order is not assigned to the kitchen: You are
                    eligible for a 100% refund of the advance payment.
                  </p>
                  <p
                    style={{ fontSize: "13px", color: "rgb(157, 74, 147)" }}
                    className="m-1"
                  ...
                  >
                    If the order is cancelled within 24 hours of the scheduled
                    delivery: The full advance amount will be non-refundable,
                    and 100% of the payment is required.
                  </p>
                </div>
              </div>
