    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Image src={`https://horaservices.com/api/uploads/${item.image}`} alt={item.name} width={100} height={60} />
            </div>
    ...
    <div style={{ width: "90%", margin: "0 auto", backgroundColor: "#EDEDED", marginBottom: "10px" }} className='selectdatesecouter'>
        ...
        <Container>
            <Step active={true.toString()}>
                <Image src={SelectDishes} alt="Select Dishes" width={48} height={48} />
                <Label active={true.toString()}>Select Dishes</Label>
            </Step>
            <Line active={true.toString()} />
            <Step>
                <Image src={SelectDateTime} alt="Select Date & Time" width={48} height={48} />
                <Label active={true.toString()}>Select Date & Time</Label>
            </Step>
            <Line />
            <Step>
                <Image src={SelectConfirmOrder} alt="Confirm Order" width={48} height={48} />
